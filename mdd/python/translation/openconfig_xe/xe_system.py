...
def xe_system_program_service(self) -> None:
    ...
    # object tracking
    if len(self.service.oc_sys__system.services.object_tracking.object_track) > 0:
        for object_track in self.service.oc_sys__system.services.object_tracking.object_track:
    ...
    if self.service.oc_sys__system.services.object_tracking.config.timer.interface_timer:
        device_cdb.ios__track.timer.interface.seconds = self.service.oc_sys__system.services.object_tracking.config.timer.interface_timer
    # nat pools
