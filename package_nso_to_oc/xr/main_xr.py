...
if (find_spec("package_nso_to_oc") is not None):
    ...
    from package_nso_to_oc.xr import xr_network_instances, xr_system, xr_interfaces, xr_acls
else:
    import common
    from xr import xr_network_instances, xr_system, xr_interfaces, xr_acls
...
def build_xr_to_oc(config_before_dict, configs_leftover, oc, translation_notes: list):
    ...
    openconfig_network_instances = xr_network_instances.main(config_before_dict, configs_leftover, translation_notes)
